...
#define __RADPOSIX__
     ...
     !defined(__RADXENON__) && !defined(__RADSEKRIT__) &&                     \
     !defined(__RADSEKRIT2__) && !defined(__RADLINUX__) &&                    \
     !defined(__RADPS2__) && !defined(__RADPSP__) && !defined(__RADPSP2__) && \
     !defined(__RADPS3__) && !defined(__RADSPU__) && !defined(__RADWII__) &&  \
...
#define RAD_F64_OR_32 double  // type is F64 if available, otherwise F32
     ...
     defined(__RADSEKRIT2__) || defined(__RADSPU__) ||                       \
     defined(__RADIPHONE__) || defined(__RADNACL__))
...
#elif defined(__RADCELL__) || defined(__RADWII__) || defined(__RADMACAPI__) || \
    defined(__RADWIIU__) || defined(__RADSEKRIT2__)
